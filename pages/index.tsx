          ...
          <div className="flex flex-row w-full">
            ...
            <div className='hidden lg:flex flex-col justify-between bg-[#ffe85c] lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-lg'>
              ...
              <div className='space-y-5'>
                ...
                <button
                  className="inline-block flex-none px-4 py-3 border-2 rounded-lg font-medium border-black bg-black text-white">Contact Us</button>
              </div>
            ...
            <div className="flex flex-1 flex-col items-center justify-center px-10 relative">
              ...
              <div className="flex flex-1 flex-col  justify-center space-y-5 max-w-md">
                ...
                <div className="flex flex-col max-w-md space-y-5">
                  ...
                  }} className="flex items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-black bg-black text-white">Confirm
                    with email</button>
