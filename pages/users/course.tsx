    ...
    return <div className="w-full px-4">
        ...
        <div className="md:flex flex-row gap-x-4 gap-y-4">
            <div className="md:w-1/2 w-full relative">
                <iframe id="iframe-video" onLoad={onLoad} src={`https://drive.google.com/file/d/1zDqeFgj6wjQQss9c_a7Vqkhb72H43PVC/preview`} sandbox="allow-scripts allow-forms allow-same-origin" className="w-full aspect-video" allow="autoplay" allowFullScreen></iframe>
