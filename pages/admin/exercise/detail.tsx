    ...
    return <React.Fragment>
        <div className="md:hero md:min-h-screen bg-base-200">
            <div className="md:hero-content">
                <div className="md:max-w-md sm:max-w-lg">
                    <div className="grid grid-cols-2 gap-4 my-4">
                        ...
                        <div className="form-control">
                            ...
                            <select value={1} className="select select-bordered w-full max-w-xs">
                        ...
                        <div className="indicator flex">
                            <div className="indicator-item badge badge-primary cursor-pointer w-12 h-12"><FontAwesomeIcon icon={faClose} /></div>
