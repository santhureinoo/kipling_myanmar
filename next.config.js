  ...
  headers: [
    {
      ...
      headers: [
        ...
        { key: "Access-Control-Allow-Headers", value: "X-CSRF-Token, X-Requested-With, Accept, Accept-Version, Content-Length, Content-MD5, Content-Type, Date, Set-Cookie, X-Api-Version" },
      ]
    }
  ],
  images: {
